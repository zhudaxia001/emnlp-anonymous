...
declare -A TASKS=(
    # Stage1任务配置
    ["stage1"]="/mnt/tenant-home_speed/dhl/VLM-R1-main/Output_Curriculum-based_RL/Stage1_True_or_False/Qwen2.5-VL-3B-3_tasks_4000:12347:Stage1_judge.py:/mnt/tenant-home_speed/dhl/VLM-R1-main/Train_sh_files/Curriculum-based_RL/stage2.sh"
    
    # Stage2任务配置
    ["stage2"]="/mnt/tenant-home_speed/dhl/VLM-R1-main/Output_Curriculum-based_RL/Stage2_Multi_choice/Stage2_Qwen2.5-VL-3B-GRPO-3_tasks_3000:12348:Stage2_choice.py:/mnt/tenant-home_speed/dhl/VLM-R1-main/Train_sh_files/Curriculum-based_RL/stage3.sh"
)
