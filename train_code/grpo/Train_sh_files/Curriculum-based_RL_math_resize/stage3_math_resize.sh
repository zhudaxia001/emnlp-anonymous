...
# 创建目录
mkdir -p /mnt/tenant-home_speed/dhl/VLM-R1-main/Output_Curriculum-based_RL_math_resize/Stage3_Open/Stage3_Qwen2.5-VL-3B-GRPO-3_tasks_3000

# 设置环境变量
export WANDB_MODE=offline  # 如果需要离线模式
export WANDB_DIR=/mnt/tenant-home_speed/dhl/VLM-R1-main/Output_Curriculum-based_RL_math_resize/Stage3_Open/Stage2_Qwen2.5-VL-3B-GRPO-3_tasks_3000
...
torchrun --nproc_per_node="8" \
    ...
    --output_dir /mnt/tenant-home_speed/dhl/VLM-R1-main/Output_Curriculum-based_RL_math_resize/Stage3_Open/Stage3_Qwen2.5-VL-3B-GRPO-3_tasks_3000 \
    --model_name_or_path /mnt/tenant-home_speed/dhl/VLM-R1-main/Output_Curriculum-based_RL_math_resize/Stage2_Multi_choice/Stage2_Qwen2.5-VL-3B-GRPO-3_tasks_3000/checkpoint-500 \
