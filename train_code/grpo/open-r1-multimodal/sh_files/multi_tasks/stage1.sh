...
RUN_NAME="Qwen2.5-VL-3B-GRPO-det_classify_math_v2_iou_fix_reward"  # /mnt/tenant-home_speed/AIM/model/Qwen2.5-VL-3B-Instruct
...
torchrun --nproc_per_node="8" \
    ...
    --output_dir /mnt/tenant-home_speed/dhl/VLM-R1-main/Restart_Output/Qwen2.5-VL-3B-GRPO-det_classify_math_v2_iou_fix_reward \
    --model_name_or_path /mnt/tenant-home_speed/AIM/model/Qwen2.5-VL-3B-Instruct \
    --dataset_name data_config/math_detection_classify_panduan.yaml \
